...
import useInterval from "_lib/hooks/useInterval";
...
const Slider = ({
    ...
    const handleMouse = useCallback(
        ...
        [onChange, trackDiv, dragging, min, max, steps, vertical]
    );
    ...
    }, [value, lastSentValue, onIntervalChange]);
    ...
    }, [dragging, stopEditing, handleMouse]);
